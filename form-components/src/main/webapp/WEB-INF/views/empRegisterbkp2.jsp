	...
	<div class="container">
		<form:form modelAttribute="empCmd" role="form">
			...
			<div class="form-group">
				...
				<form:select path="skillSetOptionsValuesMultiDropdown"
		...
		<div class="form-check">
  			<form:checkbox path="bandsMultiSelectionCheckBoxes" class="form-check-input" value="10" />
 			 <label class="form-check-label" for="defaultCheck1">
    			A
  			</label>
		</div>
		<div class="form-check">
  			<form:checkbox path="bandsMultiSelectionCheckBoxes" class="form-check-input" value="11" />
 			 <label class="form-check-label" for="defaultCheck1">
    			B
  			</label>
		</div>
		<div class="form-check">
  			<form:checkbox path="bandsMultiSelectionCheckBoxes" class="form-check-input" value="12" />
 			 <label class="form-check-label" for="defaultCheck1">
    			C
  			</label>
		</div>
			...
			<div class="form-check">
			<form:checkbox path="bandsMultiSelectionCheckBoxes" class="form-check-input" value="13" />
